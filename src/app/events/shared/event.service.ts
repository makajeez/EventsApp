...
const EVENTS: IEvent[] =  [
    {
      id: 1,
      name: 'Kano Tech Meetup',
      date: new Date('01/26/2020').toDateString(),
      time: '12:00 pm',
      price: 0,
      imageUrl: '/assets/images/angularconnect-shield.png',
      location: {
        address: 'No 45b lamido Crescent',
        city: 'Kano',
        country: 'Nigeria'
      },
      sessions: [
        ...
        },
        {
          ...
          presenter: 'Abdulhakeem Mustapha',
          duration: '1hr',
          level: 'Advanced',
        ...
        },
        {
          ...
          presenter: 'Buhari Ahmed Alhassan',
          duration: '1hr',
          level: 'Beginner',
          ...
          voters: ['bradgreen', 'igorminar','john papa','joe eames']
        }
      ]
    },
    {
      id: 2,
      name: 'Flutter Interact Viewing',
      date: new Date('12/14/2019').toDateString(),
      time: '9:00 am',
      price: 0.00,
      imageUrl: '/assets/images/ng-nl.png',
      onlineUrl: 'http://google.productView.com',
      // location: {
      ...
      sessions: [
        {
          ...
          voters: ['bradgreen', 'igorminar','makajeez','buhari']
        },
        {
          id: 2,
    ...
    },
    {
      ...
      date: new Date('12/21/2019').toDateString(),
      time: '9:00 am',
      price: 0.00,
      imageUrl: '/assets/images/ng-conf.png',
      location: {
        address: 'Bristol Palace',
        city: 'Kano',
        country: 'Nigeria'
      },
      sessions: [
